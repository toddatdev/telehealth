...
@section('content')
    ...
    <div class="nsearch-main nsearch-profile-page">
        ...
        <div class="dc-haslayout dc-main-section nuser-profile" id="user-profile">
                    ...
                    <div class="row" style="position: relative;">
                        <div class="nuser-top-controls">
                            ...
                            @if (in_array($user->id, $saved_doctors))
                                <a href="javascrip:void(0);" class="dc-like dc-clicksave"
                            ...
                            @else
                                <a href="javascrip:void(0);" class="dc-like" id="doctor-{{ intVal(clean($user->id)) }}"
                                            ...
                                            @else
                                                @if (!empty($serviceavailabledata))
                                                    @if ( in_array(strtolower(Carbon\Carbon::now()->format('D')), $serviceavailabledata) )
                                                        <?php if ($doctoravailabletodayend == "1") {  ?>
                                    ...
                                    <div class="dc-docsingle-content">
                                        ...
                                        <div class="dc-btnarea">
                                            ...
                                            <a style="background: #1BC559; color: rgb(255, 255, 255); border: 2px solid #1BC559;"
                                               ...
                                               v-b-modal.modal-sm
                                               v-on:click="showModal('appointment_modal', '{{ (Auth::check() && Helper::getRoleTypeByUserID(Auth::user()->id) == 'regular' ? 'authorise' : 'not_authorise' ) }}', '{{count($teams)}}', '1' )">{{ trans('lang.book_now') }}</a>
                                            <?php } else { ?>
                                            ...
                                            <a style="background: red; border: 1px solid red; color: #fff;"
                                               href="javascrip:void(0);" class="dc-btn">With Patient</a>
                                            <?php } } else { ?>
                                            <a href="javascript:void(0);" class="dc-btn bookingnowevent"
                                               style="background: red; border: 1px solid red;">Not Available</a>
                                            <?php } } else {  ?>
                                                    ...
                                                    <div class="dc-services-holder dc-aboutinfo">
                                                        ...
                                                        @if(isset($medicalRegistrationNumber['registration_number']))
                                                            <div class="dc-services-holder dc-aboutinfo">
                                                                <div class="dc-infotitle">
                                                                    <h3 class="profilerightsidetitle">
                                                                        <i class="fas fa-hashtag"></i>Registration
                                                                        Number
                                                                    </h3>
            ...
            {{--  Appointment Modal  --}}
            @auth
                <b-modal ref="appointment_modal" size="lg" class="dc-feedbackpopup" id="dc-feedbackpopup" hide-footer
                         title="{{ trans('lang.book_appointment') }}" no-close-on-backdrop>
                            ...
                            <section id="sec1" class="sec1">
                                ...
                                <div id="immediatebookstatecheck" class="dc-visitingdoctor" v-if="step === 1" v-cloak>
                                    <ul class="dc-joinsteps">
                                        <li class="dc-active"><a href="javascrip:void(0);">{{ trans('lang.01') }}</a>
                                        </li>
                                ...
                                <div class="dc-visitingdoctor dc-popup-doc dc-popup-step2" v-if="step === 2" v-cloak>
                                    <ul class="dc-joinsteps">
                                        <li class="dc-done-next"><a href="javascrip:void(0);"><i
                                                        class="fa fa-check"></i></a></li>
                                        <li class="dc-active"><a href="javascrip:void(0);">{{ trans('lang.02') }}</a>
                                        </li>
                                    <!--  <li><a href="javascrip:void(0);">{{ trans('lang.03') }}</a></li>
                                    <li><a href="javascrip:void(0);">{{ trans('lang.04') }}</a></li> -->
                                    </ul>
