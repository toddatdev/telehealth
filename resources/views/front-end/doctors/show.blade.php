        ...
        <div class="container">
            <div class="row">
                <div class="dc-twocolumns dc-haslayout">
					...
					<a href="/search-results" class="dc-replay"><i class="fa fa-reply"></i></a>
                                    @if (in_array($user->id, $saved_doctors))
                                        <a href="javascrip:void(0);" class="dc-like dc-clicksave" id="removedoctor-{{ intVal(clean($user->id)) }}" @click.prevent="remove_wishlist('removedoctor-{{ intVal(clean($user->id)) }}', '{{ intVal(clean($user->id)) }}', 'saved_doctors', '')" v-cloak>
				...
				<div class="dc-btnarea">				
                                    <input type="hidden" id="sessionparametercheck" name="sessionparametercheck" value="">
...
?>
				...
				<?php } } else { ?>
                                    <a style="background: red; border: 1px solid red; color: #fff;" href="javascrip:void(0);" class="dc-btn">Unavailable</a>
				<?php } } else { ?>
					<a href="javascript:void(0);" class="dc-btn bookingnowevent" style="background: red; border: 1px solid red;">Not Available</a>				
				<?php }  // } ?>
